...
= 2.3.47 =
* nonce added for ajax request to get live notification message
* user consence optiont to show name in live sales notification

= 2.3.46 =
* Tested for WC 10.5.0

= 2.3.44 =
* Code improvements

= 2.3.40 =
* option to customer to optout from showing their name in live sales notification 
